...
#**Quelques rappels condensés en théorie de la mesure** [ici](/assets/elements_integration.pdf). Tout ce dont vous avez besoin de savoir en thèorie de la mesure se trouve dans le polycopié du cours. Cette note ne fait que complémenter le cours et reste optionnelle.
...
**Pour ceux qui ne connaissent pas Latex et qui ne vont pas l'apprendre,** vous pouvez m'envoyer vos DM dans un notebook python (en markdown). 
...
[DM3-solution](/assets/DM3_solution.pdf)

# **PC4 : Vecteurs aléatoires à densité - lois conditionnelles**

[PC4](/assets/PC4.pdf)

[DM4](/assets/DM4.pdf) -- à rendre par les éléves des groupes i) (voir plus haut pour la liste) avant mercredi 13 mai à midi. Il est préférable  d'utiliser le template latex plus haut pour votre rendu ou le markdown des notebook python.

[DM4-solution](/assets/DM4_solution.pdf)

# **PC5 : Calcul de lois et vecteurs gaussiens**

[PC5](/assets/PC5.pdf)

[DM5](/assets/DM5.pdf) -- à rendre par les éléves des groupes ii) (voir plus haut pour la liste) avant mercredi 20 mai à midi. Il est préférable  d'utiliser le template latex plus haut pour votre rendu ou le markdown des notebook python.

[DM5-solution](/assets/DM5_solution.pdf)

# **PC6 : Convergences et lois des grands nombres**

[PC6](/assets/PC6.pdf)

[DM6](/assets/DM6.pdf) -- à rendre par les éléves des groupes i) (voir plus haut pour la liste) avant mercredi 27 mai à midi. Il est préférable  d'utiliser le template latex plus haut pour votre rendu ou le markdown des notebook python.

[DM6-solution](/assets/DM6_solution.pdf)

# **PC7 : Convergences en loi et TCL**

[PC7](/assets/PC7.pdf)

[DM7](/assets/DM7.pdf) -- à rendre par les éléves des groupes ii) (voir plus haut pour la liste) avant mercredi 10 juin à midi. Il est préférable d'utiliser le template latex plus haut pour votre rendu ou le markdown des notebook python.

[DM7-solution](/assets/DM7_solution.pdf)

# **PC8 : Estimation statistique**

[PC8](/assets/PC8.pdf)

[DM8](/assets/DM8.pdf) -- à rendre par les éléves des groupes i) (voir plus haut pour la liste) avant mercredi 17 juin à midi. Il est préférable d'utiliser le template latex plus haut pour votre rendu ou le markdown des notebook python.

[Question](/assets/questions.pdf)

[DM8-solution](/assets/DM8_solution.pdf)

# **PC9 : Intervalle de confiance**

[PC9](/assets/PC9.pdf)

[DM9](/assets/DM9.pdf) -- à rendre par les éléves des groupes ii) (voir plus haut pour la liste) avant mercredi 24 juin à midi. Il est préférable d'utiliser le template latex plus haut pour votre rendu ou le markdown des notebook python.


# **Survey / feedback

Si vous avez un peu de temps, pourriez-vous remplir ce [survey](https://docs.google.com/forms/d/e/1FAIpQLSdVM_BVD8AP4Qa2oxJRFu86X5WH5hsAWn1H0xCW41T5SBFfUA/viewform?usp=sf_link) ?
