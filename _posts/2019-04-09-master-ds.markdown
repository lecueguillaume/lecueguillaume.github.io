...
Il y a des cours (il y en avait 6 en 2020) qui sont ouverts dans les deux formations, par exemple le cours "Introduction mathématique au Compressed sensing" et "transport optimal". Prenons l'exemple du cours de "transport optimal" (TP). Ce cours rapporte 3 ECTS à l'ENSAE et 2.5 ECTS au Master. Ce cours n'étant pas obligatoire, vous avez 5 possibilités :
...
*__Attention__ :* Vous devez faire très attention à déduire le bon nombre de points de vos deux quotas concernant ces cours apparaissant dans le catalogue des deux formations. L'idée est de déduire de vos quota le nombre de points qu'un cours vous rapporte dans la formation d'arrivée. Ne vous trompez pas ! en cas d'erreur, vous êtes seuls responsables et si vous avez mal géré vos points d'équivalence, il se peut que vous n'ayez pas assez de points pour valider l'une ou l'autre des deux formations. Pour être bien au clair concernant ces cours, je vous demanderai dans le google doc de vos choix d'équivalence de me donner vos choix concernant ces cours ouverts dans les deux formations.
