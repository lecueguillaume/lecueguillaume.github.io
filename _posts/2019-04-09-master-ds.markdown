...
e) vous choisissez ce cours dans les deux formations; cela vous rapporte 3 ECTS à l'ENSAE, 2.5 ECTS au master et vous choisissez de déduire des points d'équivalence dans le sens Master-->ENSAE. Vous devez alors déduire 4 points d'équivalence de votre quota de 16 points d'équivalence Master-->ENSAE et 0 de votre quota ENSAE-->Master.
